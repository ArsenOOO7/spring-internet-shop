...
insert into users (balance, birth_date, email, first_name, image_id, last_name, login, password, role_id) values (999999.0, '2022-11-03', 'arsen@mail.com', 'Arsen', null, 'Sydoryk', 'ArsenOOO7', '$2a$10$CJgEoobU2gm0euD4ygru4ukBf9g8fYnPrMvYk.q0GMfOcIDtUhEwC', 2);
